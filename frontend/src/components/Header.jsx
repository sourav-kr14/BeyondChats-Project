  ...
  return (
    <header className="text-gray-600 body-font bg-white border-b sticky top-0 z-50 shadow-sm">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        {/* Navigation - Useful for filtering versions */}
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
          <a className="mr-5 hover:text-indigo-600 cursor-pointer font-medium">All Articles</a>
          <a className="mr-5 hover:text-indigo-600 cursor-pointer font-medium">Original</a>
          <a className="mr-5 hover:text-indigo-600 cursor-pointer font-medium">Enhanced</a>
        </nav>

        {/* Action Button - Connected to your Fetch logic */}
        <button 
          onClick={onRefresh}
          disabled={loading}
